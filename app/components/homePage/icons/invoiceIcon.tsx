...
export const InvoiceIcon = ({ isActive }: { isActive?: boolean }) => {
  ...
  return (
    ...
    >
      ...
      <g transform="scale(0.07) translate(220, 180)">
        <path
          fill={isActive ? '#fff' : 'currentColor'}
          d="M99.661 198h99.692a6 6 0 0 0 0-12H99.661a6 6 0 0 0 0 12zM293.937 252H99.661a6 6 0 0 0 0 12H293.937a6 6 0 0 0 0-12zM293.937 318H99.661a6 6 0 0 0 0 12H293.937a6 6 0 0 0 0-12z"
        ></path>
        <path
          fill={isActive ? '#fff' : 'currentColor'}
